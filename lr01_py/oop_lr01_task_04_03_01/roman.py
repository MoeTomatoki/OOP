...
class Roman:
    ...
    def __add__(self, other):
        ...
        if not isinstance(other, (Roman, int)):
            raise TypeError("Не могу складывать числа и {0}")
    ...
    def __sub__(self, other):
        ...
        # Уберите raise и добавьте необходимый код
        if not isinstance(other, (Roman, int)):
            raise TypeError("Не могу вычитать числа и {0}")
    ...
    def __mul__(self, other):
        ...
        # Уберите raise и добавьте необходимый код
        if not isinstance(other, (Roman, int)):
            raise TypeError("Не могу умножать числа и {0}")
    ...
    def __floordiv__(self, other):
        ...
        # Уберите raise и добавьте необходимый код
        if not isinstance(other, (Roman, int)):
            raise TypeError("Не могу делить числа и {0}")
    ...
    def __check_arabic(value):
        ...
        if not Roman.ARABIC_MIN <= value <= Roman.ARABIC_MAX:
            raise ValueError(f"Арабское число должно быть в пределах [{Roman.ARABIC_MIN}; {Roman.ARABIC_MAX}]")
        # Уберите raise и добавьте необходимый код
